...
malaria_parasite_red = Image.open('streamlit_malaria/app/images/Cell-Homepage2.png')
...
africa_spread = Image.open('streamlit_malaria/app/images/Africa-Spread-PhotoRoom.png')
